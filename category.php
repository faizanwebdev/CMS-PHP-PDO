<?php 
if(isset($_REQUEST['cat']) and !empty(trim($_REQUEST['cat']))){
    $id = htmlspecialchars(trim($_REQUEST['cat']));
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- First Blog Post -->
                <?php
                $catpost = getcatpost($id);
                if(empty($catpost)){
                    echo "<h2>No Post were found for specific category</h2>";
                }
                // $posts = getallpost();
